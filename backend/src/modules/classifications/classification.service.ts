...
export const CURRENT_MODEL_METADATA = {
  ...
  // The shipped model is fit on 10,000 rows drawn from per-class numpy.random
  // distributions by ml/src/training/train.py::construct_dataset. No FIRMS
  // detection and no OSM geometry took part in training. Its reported metrics
  // are 1.0 because the synthetic labels are a deterministic function of the
  // sampled features, and they say nothing about real-world performance.
  trainedOn:
    'Synthetic data generated by ml/src/training/train.py::construct_dataset (numpy.random). ' +
    'Not trained on NASA FIRMS detections or OpenStreetMap geometries.',
